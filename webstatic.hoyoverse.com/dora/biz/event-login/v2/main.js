/*! Copyright © 2011 - 2026 miHoYo. All Rights Reserved */
!function(t, e) {
    ...
    , function(t, e, n) {
        ...
        function s(t) {
            ...
            return new Promise((function(n, i) {
                ...
                var l = s.url;
                l.indexOf("mi18n/") < 0 ? (l = c + s.url,
                "get" === t && (s.data.ts = Date.now())) : a = !0,
                "get" === t ? (0,
                o.getJSON)(l, s.data, n, i, r({
                    withCredentials: !a
                }, !a && u ? {
                    headers: u
                } : {})) : "post" === t && (s.headers = r({
        ...
        e.default = function(t) {
            var e = t.environment
              ...
              , l = t.apiHeaders
              , f = void 0 === l ? null : l
              , p = i.DEFAULT_HOST_LIST.findIndex((function(t) {
                return -1 !== window.location.host.indexOf(t)
            }
            ))
              , d = -1 !== p ? i.DEFAULT_HOST_LIST[p] : i.DEFAULT_HOST_LIST["development" === e && n ? 1 : 0]
              , y = n ? i.API_BASE_SEA[e] : i.API_BASE_CN[e]
              , h = r({
                sea: d,
                cn: d
            }, s)[n ? "sea" : "cn"];
    ...
    , function(t, e, n) {
        ...
        (t.exports = function(t, e) {
            ...
            license: "./github.com/zloirock/core-js/blob/v3.21.0/LICENSE",
    ...
    , function(t, e, n) {
        ...
        e.DEFAULT_HOST_LIST = ["mihoyo", "hoyoverse", "miyoushe", "hoyolab"],
        e.API_BASE_CN = {
            development: "./devapi-takumi.{host}.com/common/badge/v1",
            test: "./devapi-takumi.{host}.com/common/badge/v1",
            prerelease: "./preapi-takumi.{host}.com/common/badge/v1",
            production: "./api-takumi.{host}.com/common/badge/v1"
        },
        e.API_BASE_SEA = {
            development: "./sg-act-public-api-testing.{host}.com/common/badge/v1",
            test: "./sg-act-public-api-testing.{host}.com/common/badge/v1",
            prerelease: "./sg-act-public-api-pre.{host}.com/common/badge/v1",
            production: "./sg-act-public-api.{host}.com/common/badge/v1"
        },
        e.MI18N_BASE_CN = {
            development: "./webstatic-test.mihoyo.com/admin/mi18n/",
            test: "./webstatic-test.mihoyo.com/admin/mi18n/",
            prerelease: "./webstatic.mihoyo.com/admin/premi18n/",
            production: "./webstatic.mihoyo.com/admin/mi18n/"
        },
        e.MI18N_BASE_SEA = {
            development: "./webstatic-test.hoyoverse.com/admin/mi18n/",
            test: "./webstatic-test.hoyoverse.com/admin/mi18n/",
            prerelease: "./webstatic-pre.hoyoverse.com/admin/mi18n/",
            production: "./webstatic.hoyoverse.com/admin/mi18n/"
        },
        e.MI18N_BIZ = {
            default: {
                cn: "plat_cn",
            ...
            143: function() {
                ...
                !function(e) {
                    ...
                    e.initGeetest = function(t, n) {
                        var o = new a(t);
                        t.https ? o.protocol = "./" : t.protocol || (o.protocol = e.location.protocol + "./"),
            ...
            332: function(t, e, n) {
                ...
                e.default = {
                    init: function(t) {
                        ...
                        u.default)(n) : (0,
                        c.default)(n)).takumi,
                        o && (l = ["development", "test"].includes(n) ? "./testing-sg-public-api.".concat(d(), ".com") : ["prerelease", "pre"].includes(n) ? "./account-pre-sg-public-api.".concat(d(), ".com") : "./sg-public-api.".concat(d(), ".com"),
        ...
        var u = {
            install: function(t, e) {
                ...
                t)
                    ...
                    var p = document.querySelector('[src="./webstatic.mihoyo.com/dora/lib/vue/2.6.11/vue.min.js"]');
                    if (p)
                        "undefined" == typeof Vue ? p.onload = function() {
                            c(window.Vue, e)
                        }
                        : c(window.Vue, e);
                    else {
                        var d = document.createElement("script");
                        d.src = "./webstatic.mihoyo.com/dora/lib/vue/2.6.11/vue.min.js",
                        d.onload = function() {
                            c(window.Vue, e)
                        }
                        ,
    ...
    , function(t, e, n) {
        ...
        var u = {
            login: {
                development: "./test.account".concat(c, "/Api"),
                test: "./test.account".concat(c, "/Api"),
                pre: "./pre-webapi.account".concat(c, "/Api"),
                prerelease: "./pre-webapi.account".concat(c, "/Api"),
                beta: "./webapi.account".concat(c, "/Api"),
                sandbox: "./webapi.account".concat(c, "/Api"),
                production: "./webapi.account".concat(c, "/Api")
            },
            takumi: {
                development: "./devapi-takumi".concat(c),
                test: "./devapi-takumi".concat(c),
                pre: "./preapi-takumi".concat(c),
                prerelease: "./preapi-takumi".concat(c),
                beta: "./api-takumi".concat(c),
                sandbox: "./api-takumi".concat(c),
                production: "./api-takumi".concat(c)
            },
            communtiy: {
                development: "./devapi-takumi".concat(c, "/community"),
                test: "./devapi-takumi".concat(c, "/community"),
                pre: "./bbs-api-beta".concat(c, "/community"),
                prerelease: "./bbs-api-beta".concat(c, "/community"),
                beta: "./bbs-api.mihoyo.com".concat(c, "/community"),
                sandbox: "./bbs-api.mihoyo.com".concat(c, "/community"),
                production: "./bbs-api.mihoyo.com".concat(c, "/community")
            },
            communityOld: {
                development: "./devapi".concat(c, "/community"),
                test: "./devapi".concat(c, "/community"),
                pre: "./preapi".concat(c, "/community"),
                prerelease: "./preapi".concat(c, "/community"),
                beta: "./api-community".concat(c, "/community"),
                sandbox: "./api-community".concat(c, "/community"),
                production: "./api-community".concat(c, "/community")
            }
        }
    ...
    , function(t, e, n) {
        "use strict";
        var r, o, i, a, c = n(2), u = n(25), s = n(0), l = n(14), f = n(11), p = n(149), d = n(31), y = n(305), h = n(98), v = n(39), m = n(306), g = n(18), b = n(6), x = n(10), w = n(307), _ = n(87), S = n(55), O = n(142), j = n(150), A = n(151).set, E = n(310), C = n(153), T = n(313), P = n(56), k = n(99), B = n(314), M = n(49), R = n(122), I = n(1), N = n(315), D = n(54), F = n(34), L = I("species"), U = "Promise", z = M.getterFor(U), G = M.set, H = M.getterFor(U), $ = p && p.prototype, V = p, J = $, W = s.TypeError, Q = s.document, q = s.process, Y = P.f, X = Y, Z = !!(Q && Q.createEvent && s.dispatchEvent), K = b(s.PromiseRejectionEvent), tt = !1, et = R(U, (function() {
            var t = _(V)
              , e = t !== String(V);
            if (!e && 66 === F)
                return !0;
        ...
        ,
        !u && b(p) && $ !== Object.prototype)) {
            a = $.then,
            tt || (d($, "then", (function(t, e) {
                var n = this;
    ...
    , function(t, e, n) {
        ...
        t.exports = function t(e, n, r, o) {
            ...
            if (function(t) {
                ...
                for (var G = "<" + String(e.nodeName).toLowerCase(), H = e.attributes || [], $ = 0; $ < H.length; $++)
    ...
    , function(t, e, n) {
        ...
        i()(r).call(r, "hoyoverse.com") ? "hoyoverse" : i()(r).call(r, "mihoyo.com") ? "mihoyo" : i()(r).call(r, "hoyolab.com") ? "hoyolab" : "hoyoverse"), ".com"), c = {
            login: {
                development: "./test-os.account".concat(a, "/Api"),
                test: "./test-os.account".concat(a, "/Api"),
                ue: "./ue-os.account".concat(a, "/Api"),
                pre: "./pre-os.account".concat(a, "/Api"),
                prerelease: "./pre-os.account".concat(a, "/Api"),
                beta: "./webapi-os.account".concat(a, "/Api"),
                sandbox: "./webapi-os.account".concat(a, "/Api"),
                production: "./webapi-os.account".concat(a, "/Api")
            },
            takumi: {
                development: "./devapi-os-takumi".concat(a),
                test: "./devapi-os-takumi".concat(a),
                ue: "./uebbs-api-os".concat(a),
                pre: "./preapi-os-takumi".concat(a),
                prerelease: "./preapi-os-takumi".concat(a),
                beta: "./api-account-os".concat(a),
                sandbox: "./api-account-os".concat(a),
                production: "./api-account-os".concat(a)
            },
            community: {
                development: "./testing-sg-public-api".concat(a, "/community"),
                test: "./testing-sg-public-api".concat(a, "/community"),
                ue: "./testing-sg-ue-api".concat(a, "/community"),
                pre: "./sg-bbs-api-beta".concat(a, "/community"),
                prerelease: "./sg-bbs-api-beta".concat(a, "/community"),
                beta: "./sg-bbs-api-beta".concat(a, "/community"),
                sandbox: "./bbs-api-os".concat(a, "/community"),
                production: "./bbs-api-os".concat(a, "/community")
            }
    ...
    , function(t, e, n) {
        ...
        function V() {
            ...
            this._initBody = function(t) {
                ...
                this._bodyInit = t,
                t ? "string" == typeof t ? this._bodyText = t : B && Blob.prototype.isPrototypeOf(t) ? this._bodyBlob = t : M && FormData.prototype.isPrototypeOf(t) ? this._bodyFormData = t : P && URLSearchParams.prototype.isPrototypeOf(t) ? this._bodyText = t.toString() : R && B && ((e = t) && DataView.prototype.isPrototypeOf(e)) ? (this._bodyArrayBuffer = $(t.buffer),
                this._bodyInit = new Blob([this._bodyArrayBuffer])) : R && (ArrayBuffer.prototype.isPrototypeOf(t) || N(t)) ? this._bodyArrayBuffer = $(t) : this._bodyText = t = Object.prototype.toString.call(t) : this._bodyText = "",
