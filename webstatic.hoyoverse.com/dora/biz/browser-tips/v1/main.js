...
!function(e, t) {
    "object" == typeof exports && "object" == typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define([], t) : "object" == typeof exports ? exports.miHoYoBrowserTips = t() : e.miHoYoBrowserTips = t()
          ...
          , l = function() {
            ...
            return e.init = function(e) {
                ...
                var t = e.isSea
                  ...
                  , a = void 0 === s ? "" : s
                  , u = e.list
                  , c = void 0 === u ? ["ie", "mumu", "edgeHTML"] : u
                  , l = e.onClick;
                if (o || c.some((function(e) {
                    return r.BROWSER_LIST_CONFIG[e]
                }
                ))) {
                    this.shouldRendered = !1;
                    var f = new this;
                    f.prefix = a || c.filter((function(e) {
                        return Object.keys(r.BROWSER_LIST_CONFIG).indexOf(e) >= 0
                    }
                    )).filter((function(e) {
                        return r.BROWSER_LIST_CONFIG[e]
                    }
            ...
            e.prototype.render = function() {
                ...
                t.className = "mihoyo-browser-tips " + (r.IS_MOB ? "mihoyo-browser-tips--mobile" : ""),
                t.innerHTML = this.formatInnerHTML(e),
                this.onClick && t.addEventListener("click", this.onClick),
                window.document.body.appendChild(t)
            }
            ,
            e.prototype.getPrefixConfig = function(e) {
                var t = this
                  , n = {};
                return i.COMMON_CONFIG_KEY_MAPS.forEach((function(i) {
                    var o = t.prefix ? t.prefix + "_" + i : i
                      , s = e[o];
                    (0,
                    r.isNotExtend)(s) ? n[i] = "" : n[i] = e[o] || e[i]
                }
                )),
                n
            }
            ,
            e.prototype.formatInnerHTML = function(e) {
                var t = e.bg
                  , n = e.slogan
                  , r = e.title_color
                  , i = e.desc_color
            ...
            ,
            e.prototype.getBrowserList = function() {
                var e = this;
                return this.config.show_browser ? c([], Array(i.BROWSER_ITEM_NUM), !0).map((function(t, n) {
                    return {
                        link: e.config["browser" + (n + 1) + "_link"],
                        name: e.config["browser" + (n + 1) + "_name"],
                        icon: e.config["browser" + (n + 1) + "_icon"]
                    }
                }
                )).filter((function(e) {
                    return e.link
            ...
            e.prototype.getJsonUrl = function() {
                return "./webstatic" + (this.isSea ? ".hoyoverse" : ".mihoyo") + ".com/admin/mi18n/" + (this.isSea ? "plat_oversea" : "plat_cn") + "/m10081518461181/m10081518461181-" + this.lang + ".json"
            }
            ,
            ...
            e.prototype.getLang = function() {
                if (!this.isSea)
                    return "zh-cn";
                var e = o.default.checkLang(r.QS.lang || s.default.get("mi18nLang") || o.default.getGameLang());
                return i.LANG_MAPS.filter((function(t) {
                    return t === e
                }
                ))[0] || "en-us"
            }
            ...
            for (var n = 0; n < e.length; n++) {
                ...
                if (i) {
                    ...
                    for (; s < r.parts.length; s++)
                        i.parts.push(g(r.parts[s], t))
                } else {
                    var a = [];
                    for (s = 0; s < r.parts.length; s++)
                        a.push(g(r.parts[s], t));
                    o[r.id] = {
                        id: r.id,
                        refs: 1,
                        parts: a
        ...
        function b(e, t) {
            ...
            if ("top" === e.insertAt)
                ...
                if ("object" != typeof e.insertAt || !e.insertAt.before)
                    throw new Error("[Style Loader]\n\n Invalid value for parameter 'insertAt' ('options.insertAt') found.\n Must be 'top', 'bottom', or Object.\n (./github.com/webpack-contrib/style-loader#insertat)\n");
    ...
    , function(e, t, n) {
        ...
        t.isNotExtend = t.IS_MOB = t.BROWSER_LIST_CONFIG = t.isEdgeHTML = t.isMumu = t.QS = t.qs = t.isIE = void 0;
        var r, i = n(7), o = (r = i) && r.__esModule ? r : {
            default: r
        };
        var s = t.isIE = !(!window.ActiveXObject && !("ActiveXObject"in window))
          , a = t.qs = function(e) {
          ...
          , u = (t.QS = a(),
        t.isMumu = o.default.mumu())
          , c = t.isEdgeHTML = function(e) {
            var t = e.match(/Edge\/(\d+)/) || [];
            return !!(t[1] && +t[1] < 19)
        }
        ;
        t.BROWSER_LIST_CONFIG = {
            ie: s,
            mumu: u,
            edgeHTML: c(navigator.userAgent)
        },
        t.IS_MOB = "mobile" === o.default.getDeviceType(),
        t.isNotExtend = function(e) {
            return "-" === e
        }
    }
    , function(e, t, n) {
                ...
                var n = function() {
                  ...
                  , i = {
                    ...
                    formatParams: function(e) {
                        ...
                        return Object.keys(t).reduce((function(e, n) {
                            return e.push(encodeURIComponent(n) + "=" + encodeURIComponent(t[n])),
                            e
                        }
                        ), []).join("&")
                    },
                    ...
                    isEmpty: function(e) {
                        var t = !0;
                        return e && "string" == typeof e && String(e).trim() && (t = !1),
                        t
                    },
                    dealStr: function(e, t) {
                        var n = String(e).trim() || "";
                        return "lower" === t ? n.toLowerCase() : "upper" === t ? n.toUpperCase() : n
                    },
                    includes: function(e, t) {
                        return -1 !== e.indexOf(t)
                    },
                    find: function(e, t) {
                        return this.includes(t, e)
                    },
                  ...
                  , o = function() {
                    ...
                    return n(t, [{
                        ...
                        key: "desktop",
                        value: function() {
                            return "pc" === this.platform() || !this.tablet() && !this.mobile()
                        }
                    }, {
                        key: "portrait",
                        value: function() {
                            var e = this.window;
                            return e ? screen.orientation && Object.prototype.hasOwnProperty.call(e, "onorientationchange") ? this.includes(screen.orientation.type, "portrait") : this.ios() && Object.prototype.hasOwnProperty.call(e, "orientation") ? 90 !== Math.abs(e.orientation) : e.innerHeight / e.innerWidth > 1 : "mobile" === this.getDeviceType()
                        }
                    }, {
                        key: "landscape",
                        value: function() {
                            var e = this.window;
                            return e ? e.screen.orientation && Object.prototype.hasOwnProperty.call(e, "onorientationchange") ? this.includes(e.screen.orientation.type, "landscape") : this.ios() && Object.prototype.hasOwnProperty.call(e, "orientation") ? 90 === Math.abs(e.orientation) : e.innerHeight / e.innerWidth < 1 : !this.portrait()
                        }
                    }, {
                        key: "getOrient",
                        value: function() {
                        ...
                        value: function() {
                            var e = void 0;
                            return this.desktop() ? e = "desktop" : this.tablet() ? e = "tablet" : this.mobile() ? e = "mobile" : console.warn("unknown device end"),
                            e
                        }
                    }, {
                        key: "getDeviceType",
                        value: function() {
                            var e = this.desktop() ? "pc" : this.tablet() || this.mobile() ? "mobile" : void 0;
                            if (!e) {
                                var t = i.dealStr(this.queryString("device_type"));
                                if (!i.isEmpty(t)) {
                                    var n = i.findIndex(r, (function(e) {
                                        return -1 !== t.search(e)
                                    }
                                    ));
                                    e = -1 !== n ? r[n] : void 0
                                }
                                e || console.warn("unknown device type")
                            }
                            return e
                        }
                    }, {
                        key: "platform",
                        value: function() {
                            return i.dealStr(this.queryString("plat_type"), "lower")
                        }
                    }, {
                        key: "trident",
                        value: function() {
                        ...
                        key: "ipad",
                        value: function() {
                            return this.find("ipad") || this.window && "MacIntel" === this.window.navigator.platform && this.window.navigator.maxTouchPoints > 1
                        }
                    }, {
                        key: "macos",
                        value: function() {
                        ...
                        key: "othersMobile",
                        value: function() {
                            return !!this.userAgent.match(/mobile|iemobile|mqqbrowser|juc|fennec|wosbrowser|browserng|webos|symbian|huaweibrowser/i)
                        }
                    }, {
                        key: "includes",
                        value: function(e, t) {
                        ...
                        value: function(e) {
                            ...
                            return t ? i.includes(t, e) : i.find(e, this.userAgent)
                        }
                    }, {
                        key: "queryString",
                        value: function(e) {
                            return i.queryString(e, this.url)
                        }
                    }]),
                    t
                }();
                ...
                function t(e) {
                    ...
                    e)
                        var n = e.url
                          ...
                          , o = r["user-agent"] || ""
                          , s = r["accept-language"]
                          , a = /([a-z0-9_-]+)(\s|,|;|$)/i.exec(s)
                          , u = (a && a[1] || "").toLowerCase()
                          , c = i(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, {
                            url: n,
                            userAgent: o,
                            language: u
                        }));
                ...
                function t() {
                    ...
                    function(e, t) {
                        if (!e)
                            throw new ReferenceError("this hasn't been initialised - super() hasn't been called");
                        return !t || "object" != typeof t && "function" != typeof t ? e : t
                    }(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, void 0))
                }
                return function(e, t) {
                    if ("function" != typeof t && null !== t)
                        throw new TypeError("Super expression must either be null or a function, not " + typeof t);
        ...
        , function(e, t, n) {
            ...
            t.MhyBrowser = void 0;
            var r, i = (r = n(3)) && r.__esModule ? r : {
                default: r
            };
            t.default = new i.default,
            t.MhyBrowser = i.default
        }
        ]).default
    }
    , function(e, t, n) {
        ...
        var r = function(e, t, n) {
          ...
          , i = t.BROWSER_ITEM_NUM = 5;
        t.COMMON_CONFIG_KEY_MAPS = r(["bg", "slogan", "title_color", "desc_color", "title", "desc", "logo", "btn_color", "text_color", "show_browser"], r([], Array(i), !0).reduce((function(e, t, n) {
            var i = ["browser" + (n + 1) + "_link", "browser" + (n + 1) + "_name", "browser" + (n + 1) + "_icon"];
            return r(r([], e, !0), i, !0)
        }
        ), []), !0),
        t.LANG_MAPS = ["zh-cn", "zh-tw", "de-de", "en-us", "es-es", "fr-fr", "id-id", "it-it", "ja-jp", "ko-kr", "pt-pt", "ru-ru", "th-th", "tr-tr", "vi-vn"]
    }
    , function(e, t, n) {
        "use strict";
        (function(e) {
            ...
            var r, i = n(11), o = (r = i) && r.__esModule ? r : {
                default: r
            };
            var s = "undefined" == typeof window && void 0 !== e;
            t.default = {
                ...
                getBrowserInfo: function() {
                    var e, t = {
                        versions: (e = navigator.userAgent,
                        {
                    ...
                    return {
                        deviceType: t.versions.mobile || t.versions.ios || t.versions.android || t.versions.iPhone || t.versions.iPad ? "mobile" : "pc",
                        language: t.language
                    }
                },
                getGameLang: function() {
                    var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : ""
                      , t = o.default[this.dealStr(e)];
                    if (s)
                        return t;
                    var n = this.getBrowserInfo()
                      , r = n.language
                      , i = this.getParameterByName("lang")
                      , a = navigator.userAgent.toLowerCase()
                      , u = a.indexOf("mihoyo")
                      , c = r;
                    return t ? c = t : i && (c = o.default[this.dealStr(i)]) || (c = this.getDefaultLang(a, u, r)),
                    c
                },
                getDefaultLang: function(e, t, n) {
                    var r = void 0;
                    if (t > -1)
                        r = e.substr(t).trim().split("/")[3];
                    else {
                        var i = o.default[this.dealStr(n)];
                        r = i || n
                    }
                    return r
                },
                checkLang: function(e) {
                    return o.default[this.dealStr(e)] || ""
                }
            }
        }
        ).call(this, n(10))
                ...
                function i(t, i, o) {
                    if ("undefined" != typeof document) {
                        ...
                        for (var a in o)
                            o[a] && (s += "; " + a,
                            !0 !== o[a] && (s += "=" + o[a].split(";")[0]));
                        return document.cookie = t + "=" + n.write(i, t) + s
                    }
                }
